...
//            }
            ...
            if (yPos > midPoint) {
                ...
                mContentTopMargin = 0;
                mContentBottomMargin = (height - yPos) + radius + mShapePadding;//这样设置 加的布局在高亮区的上面
                mGravity = Gravity.BOTTOM;
            } else {
                // target is in upper half of screen, we'll sit below it
                mContentTopMargin = yPos + radius + mShapePadding;//这样设置 加的布局在高亮区的下面
//                mContentTopMargin = 0;//这样设置  加的布局铺满整个屏幕
