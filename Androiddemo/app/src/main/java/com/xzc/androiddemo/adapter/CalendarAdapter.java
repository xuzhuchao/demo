package com.xzc.androiddemo.adapter;
...
import com.xzc.androiddemo.adapter.rilikongjian.LunarCalendar;
import com.xzc.androiddemo.adapter.rilikongjian.SpecialCalendar;
...
//		currentDay = String.valueOf(day);  //得到跳转到的天
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(dv != null ||dv != ""){
			sp.setSpan(new RelativeSizeSpan(0.5f), d.length()+1, dayNumber[position].length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		}
//		sp.setSpan(new ForegroundColorSpan(Color.MAGENTA), 14, 16, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		textView.setText(sp);
//		LogUtils.i(" d = " +d);
//		LogUtils.i(" dv = " +dv);
//		LogUtils.e(" sp = " +sp);//带节日和农历
...
//		}
		...
		if (position < daysOfMonth + dayOfWeek && position >= dayOfWeek) {
			// 当前月信息显示
//			textView.setTextColor(context.getResources().getColor(R.color.b));// 当月字体设黑
...
//					textView.setBackgroundResource(R.drawable.mark);
		...
		if(currentFlag == position){
			...
			textView.setTextColor(context.getResources().getColor(R.color.but_text_color));
			textView.setBackgroundResource(R.color.background);
		}else if(position<getStartPositon()-7){
//			LogUtils.e("--------position ="+position);
//			LogUtils.e("--------getEndPosition ="+getStartPositon());
			textView.setTextColor(context.getResources().getColor(R.color.background));
		}else if(position>getEndPosition()-7){
//			LogUtils.e("--------position ="+position);
//			LogUtils.e("--------getEndPosition ="+getEndPosition());
			textView.setTextColor(context.getResources().getColor(R.color.background));
		}
	...
	public void getCalendar(int year, int month){
		...
		LogUtils.i(isLeapyear+" ======  "+daysOfMonth+"  ============  "+dayOfWeek+"  =========   "+lastDaysOfMonth);
		getweek(year,month);
	}
