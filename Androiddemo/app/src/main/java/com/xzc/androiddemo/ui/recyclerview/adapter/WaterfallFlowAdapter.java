...
public class WaterfallFlowAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WaterfallFlowAdapter(List<TestEntity> mDatas, Context mContext) {
        this.mDatas = mDatas;
